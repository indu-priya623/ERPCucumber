Feature:
As a admin want to validate customer module
@customer
Scenario Outline:
...
When wait for customer with "xpath" and "//input[@id='x_Customer_Number']"
When capture customer number with "xpath" and "//input[@id='x_Customer_Number']"
When enter customer name in "<customername>" with "xpath" and "//input[@id='x_Customer_Name']"
...
|chandu4|ameerpet4|hyderabad|india|sai|9876543212|chandu@gmail.com|8765432345|i am customer|
|chandu5|ameerpet5|hyderabad|india|sai|9876543212|chandu@gmail.com|8765432345|i am customer|
|chandu6|ameerpet5|hyderabad|india|sai|9876543212|chandu@gmail.com|8765432345|i am customer|
|chandu7|ameerpet6|hyderabad|india|sai|9876543212|chandu@gmail.com|8765432345|i am customer|
